...
class CreditCooperativeStatus {
  const CreditCooperativeStatus({
  ...
  factory CreditCooperativeStatus.fromJson(Map<String, dynamic> json) {
    return CreditCooperativeStatus(
